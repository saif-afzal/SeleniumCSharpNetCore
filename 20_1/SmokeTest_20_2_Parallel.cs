...
namespace ParallelTestingSolution
{
    ...
    public class SmokeTest_20_2_Parallel : BrowserStackNUnitTest
    {
      

        public SmokeTest_20_2_Parallel(string profile, string environment) : base(profile, environment) {  }
    ...
    string generalcoursetitle = "GC_Reg" + Meridian_Common.globalnum;
        ...
        public void LoginSmoke_8597()
        {
            ...
            Assert.IsTrue(homePage1.Title == "Home");//checks the Home page title
        }
        ...
        public void Create_SCROM_Course_7251()
        {
            ...
            StringAssert.IsMatch("The course was created.", summaryPage1.GetSuccessMessage(), "Error message is different");
