...
namespace Selenium2.Meridian.Suite
{
   ...
   // [Parallelizable(ParallelScope.Fixtures)]
    class P2RecommendationContentTagTest : TestBase
    {
        string browserstr = string.Empty;

        public P2RecommendationContentTagTest(string browser)
            : base(browser)
        {
        ...
        public void A_Admin_Create_A_Content_Tag_36023()
        {
        ...
        public void B_Remove_A_Content_Tag_36024()
        {
        ...
        public void C_Admin_Search_For_Content_Tag_36025()
        {
            CommonSection.Manage.Training();
            TrainingPage.SearchRecord(generalcoursetitle);
            ManageContentPage.ClickContentTitle(generalcoursetitle);
        ...
        public void E_Admin_Accociate_Content_Into_Tag_36026()
        {
            CommonSection.Manage.Training();
            TrainingPage.SearchRecord(generalcoursetitle);
            ManageContentPage.ClickContentTitle(generalcoursetitle);
        ...
        public void D_Admin_Remove_Accociated_Content_From_Tag_36027()
        {
            CommonSection.Manage.Training();
            TrainingPage.SearchRecord(generalcoursetitle);
            ManageContentPage.ClickContentTitle(generalcoursetitle);
     ...
     //   [Test, Order(36)]
        ...
        [Test, Order(34), Category("AutomatedP1")]
        ...
        [Test, Order(35), Category("AutomatedP1")]
