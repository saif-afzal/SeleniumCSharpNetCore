...
namespace Selenium2
{
 ...
 //[SetUpFixture]
    public class TestBase : Selenium2TestBase
    {
        ...
        public string passwd(string browser)
        {
            if (browser == "1")
            {
        ...
        public string username(string browser)
        {
            if (browser == "1")
                return "siteadmin";
            else if (browser == "2")
        ...
        public string rootfolder(string browser)
        {
            if (browser == "1")
                return "a";
            else if (browser == "2")
        ...
        public string Url(string browser)
        {
            if (browser == "1")
            {
        ...
        public TestBase(string browser)
        {
            ...
            if (ConfigurationManager.AppSettings["Selenium2Browser"] == null)
            {
                ...
                if (ConfigurationManager.AppSettings["selenium2browserMch"] == browser)
                {
                    //  Meridian_Common.MeridianTestbrowser = browser;
                    driver = StartBrowser(browser);
                    driver.Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(1);
                ...
                {
                    if (ConfigurationManager.AppSettings["selenium2browserch"] == "chbs")
                    {
                        driver = StartBrowser(ConfigurationManager.AppSettings["selenium2browserch"]);
                        driver.Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(1);
                    }
                    if (ConfigurationManager.AppSettings["selenium2browserch"] == "chbsedge")
                    {
                        driver = StartBrowser(ConfigurationManager.AppSettings["selenium2browserch"]);
                        driver.Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(1);
                    }
        ...
        //public GeneralCourse generalcourseobj;
        ...
        //public EditOrganization EditOrganizationobj;
        //public SelectManager SelectManagerobj;
        //public Role Roleobj;
        ...
        //public CurrentTrainings CurrentTrainingsobj;
        //internal Scorm12 scormobj;
        //public AICC aicccourse;
