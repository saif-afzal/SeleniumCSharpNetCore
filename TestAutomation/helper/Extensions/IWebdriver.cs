...
namespace OpenQA.Selenium
{
    ...
    public static void ClickAnchor(this IWebElement driver)
        ...
        public static string GetBrwser(this IWebElement driver)
        {
          ...
          {
              Browser=((OpenQA.Selenium.Remote.RemoteWebDriver)(((OpenQA.Selenium.Remote.RemoteWebElement)(driver)).WrappedDriver)).Capabilities.GetCapability("browser").ToString();
          }
    ...
    public static class IWebDriverExtensions
    {
        ...
        public static bool checkElementExists(this IWebDriver driver,By by, int seconds)
        {
            bool result = false;
            try
            {
        ...
        public static bool focusParentWindow(this IWebDriver driver)
        {
        ...
        public static void hoverLink(this IWebDriver driver,string firsttab, string childtab)
        {
        ...
        public static bool? checkTitle(this IWebDriver driver, string Title)
        {
            return (Driver.Instance.Title.ToString() == Title);
        }
        public static int getIntegerFromString(this IWebDriver driver, string extractText)
        {
        ...
        public static bool matchmonth(this IWebDriver driver, By by)
        {
        ...
        public static bool verifyFile(this IWebDriver driver,string filename)
        {
            Thread.Sleep(20000);
            ...
            if (File.Exists(Meridian_Common.MeridianFileDownload + filename))
            {
                ...
                var wdw = driver.CurrentWindowHandle;
        ...
        public static void waitforframe(this IWebDriver driver)
        {
        ...
        public static bool SelectChildWindow(this IWebDriver driver)
        {
            ReadOnlyCollection<string> handles = driver.WindowHandles;
            if (handles.Count > 1)
            {
        ...
        public static void findanddismissalert(this IWebDriver driver)
        {
            TimeSpan defaultTimeout = new TimeSpan(0, 0, 0, 10);
            var wait = new WebDriverWait(driver, defaultTimeout);
            Thread.Sleep(3000);
