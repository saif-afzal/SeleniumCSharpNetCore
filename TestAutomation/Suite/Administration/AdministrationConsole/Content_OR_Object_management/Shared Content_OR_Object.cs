...
namespace Selenium2.Meridian.Suite.Administration.AdministrationConsole.Content_OR_Object_management
{
    ...
    class SharedObjects : TestBase
    {
        string browserstr = string.Empty;
        public SharedObjects(string browser)
            : base(browser)
        {
            browserstr = browser;
        }
