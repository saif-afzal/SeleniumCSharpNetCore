       ...
       //         driverobj.select(locator.contentsearchSearchfilterdrpdwn, filtertext);
        ...
        public bool editActivityMarkInactive()
        {
            ...
            try
            {
                ...
                driverobj.WaitForElement(By.XPath("//h1[contains(.,'Activity')]"));
        ...
        public void CreateDocuemntCourse(string browserstr)
        {
            ...
            Thread.Sleep(2000);
            driverobj.GetElement(By.CssSelector("input[value='Check-in']")).ClickWithSpace();
            Thread.Sleep(2000);
        }
        ...
        public bool shareDocument(string browserstr)
        {
            ...
            try
            {
                ...
                driverobj.WaitForElement(By.XPath("//h1[contains(.,'Content Sharing')]"));
        ...
        public bool sètImage(string browserstr)
        {
            ...
            try
            {
                ...
                driverobj.WaitForElement(By.XPath("//h1[contains(.,'Image')]"));
