...
namespace Selenium2.Meridian.Suite
{
    ...
    class DonotuseRecommendationTag : TestBase
    {
        string browserstr = string.Empty;

        public DonotuseRecommendationTag(string browser)
            : base(browser)
        {
        ...
        public object TrainingHomesPage { get; private set; }
        [OneTimeSetUp]
        ...
        [Test, Order(3)]
        public void C_Remove_A_Content_Tag_33188()
        {
        ...
        [Test, Order(2)]
        public void B_Admin_Search_For_Content_Tag_33176()
        {
        ...
        [Test, Order(4)]
        public void D_Admin_Accociate_Content_Into_Tag_33164()
        {
        ...
        [Test, Order(5)]
        public void E_Admin_Remove_Accociated_Content_From_Tag_33165()
        {
        ...
        public void Select_remove_interests_from_profile_page_33479()
      
        {
            //Pre-requisite - Recommendations based on Content Tags must be enabled
            //- Tags must exist in the systems
            ...
            Assert.IsTrue(AccountPage.Interests.EditLink);
            ...
            AccountPage.EditInterestsModal.SelectInterests(); //Select multiple Interests and click on Done
            Assert.IsTrue(AccountPage.Interests.InterestsAdded()); //Verify the modal is closed and in the Account page the Interests are added
            AccountPage.Interests.ClickEditLink();
            Assert.IsTrue(AccountPage.EditInterestsModal.MultipleSelectedInterests());
            AccountPage.EditInterestsModal.DeSelectInterests(); //Deselect selected Interests from the modal
            Assert.IsTrue(AccountPage.Interests.InterestsRemovedfromModal()); //Verify the modal is closed and in the Account page the Interests are removed
            AccountPage.Interests.ClickEditLink(); //Select individual Interests
            AccountPage.EditInterestsModal.SelectInterests();
            Assert.IsTrue(AccountPage.Interests.InterestsRemovedfromAccountsPage()); //Individual Interest is removed
            CommonSection.Logout();
        }

        [Test, Order(19)]

        public void Delete_a_Tag_and_verify_it_does_not_appear_as_interest_to_Learner_33492()
        ...
        public void Interest_Section_is_not_displayed_when_disabled_the_Content_Tags_from_Recommendations_33493()

        {

            LoginPage.LoginAs("Admin").WithPassword("").Login(); //Login as an Admin
            CommonSection.Manage.Recommendations();
            RecommendationsPage.ContentTagsSection.ClickDisabled(); // To Disable the Interest Section
            StringAssert.AreEqualIgnoringCase("The changes were saved", Driver.getSuccessMessage(), "Error message is different");
            CommonSection.Logout();
            LoginPage.LoginAs("reguser").WithPassword("").Login(); //Login as regular user (Learner)
            CommonSection.Avatar.Account();
            AccountPage.ClickProfiletab();
            Assert.IsTrue(AccountPage.ProfileTab.NoInterestsSection); //Interest Section is not displayed
            CommonSection.Logout();
            LoginPage.LoginAs("siteadmin").WithPassword("").Login(); //Login as an Admin
            CommonSection.Manage.Recommendations();
            RecommendationsPage.ContentTagsSection.ClickEnabled();
            StringAssert.AreEqualIgnoringCase("The changes were saved", Driver.getSuccessMessage(), "Error message is different");
            CommonSection.Logout();
            LoginPage.LoginAs("reguser").WithPassword("").Login(); //Login as regular user (Learner)
            CommonSection.Avatar.Account();
            AccountPage.ClickProfiletab();
            Assert.IsTrue(AccountPage.ProfileTab.isInterestsSectionDisplayed); //Interest Section is displayed
            CommonSection.Logout();
        ...
        public void Learner_see_Instruction_Text_when_adding_removing_Interests_from_Profile_33636()
        { 
            CommonSection.Avatar.Account();
            AccountPage.ClickProfiletab();
        ...
        [Test]
        public void Create_a_new_OJT_item_24033()
        {
        ...
        [Test]
        public void Manage_an_OJT_item_24034()
        {
            ClassroomCourse classroomcourse = new ClassroomCourse(driver);
            OJT onlinejobtraining = new OJT(driver);
        ...
        [Test]
        public void Create_a_new_SCORM_course_7251()
        {
        ...
        [Test]
        public void Manage_a_SCORM_course_7253()
        {
            Scorm12 CreateScorm = new Scorm12(driver);
            Document documentpage = new Document(driver);
            CommonSection.CreateLink.SCORM();
        ...
        [Test]
        public void e93_Create_a_new_document_using_a_URL_7285()
        {
            //   driver.UserLogin("admin",browserstr);
            CommonSection.CreateLink.Document();
        ...
        [Test]
        public void e96_Manage_a_document_7333()
        {
            string expectedresult = " The changes were saved.";
            string actualresult = string.Empty;
            CommonSection.CreateLink.Document();
        ...
        [Test]
        public void e100_Create_a_new_General_course_7373()
        {
        ...
        [Test]
        public void e102_Manage_a_General_course_7375()
        {
            CommonSection.CreateLink.GeneralCourse();
        ...
        [Test]
        public void g135_Create_a_new_AICC_course_7401()
        {
            Document documentpage = new Document(driver);
           // driver.UserLogin("admin", browserstr);
            string expectedresult = "Summary";
        ...
        [Test]
        public void g137_Manage_an_AICC_course_7402()
        {
        ...
        [Test]
        //Creating a Bundle
        public void A_CreateANewBundle_10455()
        {
        ...
        [Test]
        public void C_ManageABundle_10574()
               {
        ...
        public void A_CreateANewSubscription_10853()
        {
           ...
           [Test]
            public void C_ManageASubscription_10854()
            {
        ...
        public void A_CreateANewCurriculum_10822()
        {
        ...
        //   StringAssert.AreNotEqualIgnoringCase(Variables.curriculumTitle + browserstr,SearchResultsPage.MatchRecord(Variables.curriculumTitle + browserstr));
         ...
         [Test]
          public void C_ManageACurriculum_10823()
          {
        ...
        public void A_CreateANewCertification_10878()
        {
        ...
        public void C_ManageACertification_10879()
        {
            CommonSection.CreateLink.Certifications();
            // objCreate.FillCertificationPageByExcel(driver);
          //  Assert.IsTrue(Driver.checkTagsonContentCreationPage(true));
        ...
        public void NF17_Interest_Section_is_not_displayed_when_disabled_the_Content_Tags_from_Recommendations_33493()

        {
            ...
            CommonSection.Manage.Recommendations();
            RecommendationsPage.ContentTagsSection.ClickDisabled(); // To Disable the Interest Section
            Assert.IsTrue(Driver.comparePartialString("The changes were saved", RecommendationsPage.GetSuccessMessage()));
            CommonSection.Logout();
            LoginPage.LoginAs("userreg_0403012001people1").WithPassword("").Login(); //Login as regular user (Learner)
            CommonSection.Avatar.Account();
            AccountPage.ClickProfileTab();
            Assert.IsFalse(AccountPage.ProfileTab.InterestsSection); //Interest Section is not displayed
            CommonSection.Logout();
            LoginPage.LoginAs("").WithPassword("").Login(); //Login as an Admin
            CommonSection.Manage.Recommendations();
            RecommendationsPage.ContentTagsSection.ClickEnabled();
            Assert.IsTrue(Driver.comparePartialString("The changes were saved", RecommendationsPage.GetSuccessMessage()));
            CommonSection.Logout();
            ...
            CommonSection.Avatar.Account();
            AccountPage.ClickProfileTab();
            Assert.IsTrue(AccountPage.ProfileTab.InterestsSection); //Interest Section is displayed
                                                                    //CommonSection.Logout();
                                                                    //  LoginPage.LoginAs("").WithPassword("").Login();
        ...
        public void NF18_Delete_a_Tag_and_verify_it_does_not_appear_as_interest_to_Learner_33492()
        //Pre-requisite - Recommendations based on Content Tags must be enabled
        // Tags must exist in the system

        {
            ...
            CommonSection.Avatar.Account();
            AccountPage.ClickProfileTab();
            Assert.IsTrue(AccountPage.InterestsSection.EditLink);
            AccountPage.InterestsSection.ClickEditLink();
            Assert.IsTrue(AccountPage.EditInterestsModal.MultipleInterests); //Verify the Edit Interest Modal is displayed with multiple Interests/Tags
            AccountPage.EditInterestsModal.SelectInterestTag();
            AccountPage.EditInterestsModal.ClickDone(); //Select one Interest
            Assert.IsTrue(AccountPage.InterestsSection.InterestsAdded); //Verify the modal is closed and in the Account page the Interests are added
            SelectInterestTag = AccountPage.EditInterestsModal.SelectInterestTagname;
            CommonSection.Logout();

            LoginPage.LoginAs("").WithPassword("").Login(); //Login as an Admin
            CommonSection.Administer.TrainingManagement.ContentTag();
            Assert.IsTrue(ContentTagPage.ListofTagsDisplay);

            ContentTagPage.EnterTagToSearch(SelectInterestTag);
            ContentTagPage.ClickButton_Search(SelectInterestTag);
            ContentTagPage.SelectSearchtag();
            ContentTagPage.ClickButtonRemove();
            //SearchTag.selectcheckbox.clickDelete();
            StringAssert.AreEqualIgnoringCase("Are you sure you want to delete the selected items? Select OK to proceed or Cancel to do nothing.", ContentTagPage.GetRemoveConfimationMessage(), "Meesage is different");
            //Messagebox."Are you sure you want to delete the selected items? Select OK to proceed or Cancel to do nothing".ClickOK();
            ContentTagPage.ClickOKinDeleteConfirmationModal();
            Assert.IsTrue(Driver.comparePartialString("The selected items were deleted", ContentTagPage.GetSuccessMessage()));//, "Error message is different");
            //Assert.IsTrue(ContentTagPage.ListofTags.ContentTagDeleted); //Verify the deleted content tag is not displayed
            CommonSection.Logout();

            LoginPage.LoginAs("userreg_0403012001people1").WithPassword("").Login(); //Login as regular user (Learner)
            CommonSection.Avatar.Account();
            AccountPage.ClickProfileTab();
            Assert.IsFalse(AccountPage.InterestsSection.InterestsAdded); //Verify the deleted content tag is not displayed
            CommonSection.Logout();
            LoginPage.LoginAs("").WithPassword("").Login();
        }
        [Test, Order(136)]
        public void NF36_Catalog_Search_By_Using_Content_Tags_Facets_33557()
