...
namespace Selenium2.Meridian.Suite.Administration.ECommerce
{
    ...
    class ManageTaxRateold : TestBase
    {
        string browserstr = string.Empty;
        public ManageTaxRateold(string browser)
            : base(browser)
        {
            browserstr = browser+"mtro";
        ...
        public void a_Add_a_new_tax_table()
        {
            ...
            driver.GetElement(By.XPath("//a[contains(.,'Currency and Taxes')]")).ClickWithSpace();
