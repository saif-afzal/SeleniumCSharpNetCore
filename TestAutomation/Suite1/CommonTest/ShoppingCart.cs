...
namespace Selenium2.Meridian.Suite.CommonTest
{
    ...
    class ShoppingCartold : TestBase
    {
        string browserstr = string.Empty;
        string generalCoursePaidCourseTitle = string.Empty;
        public ShoppingCartold(string browser)
            : base(browser)
        {
        ...
        public void C_User_Views_Total_Item_Count_24761_24762()
        {
            ...
            Assert.IsTrue(driver.existsElement(By.XPath("//a[contains(.,'"+ title +"')]")));
            Assert.IsTrue(driver.existsElement(By.XPath("//input[@size='1']")));
            ...
            Thread.Sleep(1000);
            Assert.IsTrue(driver.existsElement(By.XPath("//input[@value='99']")));
            Assert.IsTrue(driver.existsElement(By.XPath("//p[contains(.,'$99.00')]")));
            Assert.IsTrue(driver.existsElement(By.XPath("//div[contains(@class,'alert alert-success')]")));
 ...
 //          Assert.IsTrue( CheckOutobj.PlaceOrder()); 
        ...
        public void F_c_User_View_Order_History_US1913()
        {
         ...
         //   Contentobj.AddCostToGeneralCourse();
            ...
            Assert.IsTrue(driver.existsElement(By.XPath("//a[contains(.,'" + ExtractDataExcel.MasterDic_genralcourse["Title"] + "')]")));
            Assert.IsTrue(driver.existsElement(By.XPath(".//*[@id='ctl00_MainContent_UC1_rgOrderHistory_ctl00__0']/td[1]")));
            Assert.IsTrue(driver.existsElement(By.XPath(".//*[@id='ctl00_MainContent_UC1_rgOrderHistory_ctl00__0']/td[2]")));
            Assert.IsTrue(driver.existsElement(By.Id("MainContent_UC1_lnkRedeemAccessKeys")));
            driver.LogoutUser(ObjectRepository.LogoutHoverLink, ObjectRepository.HoverMainLink);
