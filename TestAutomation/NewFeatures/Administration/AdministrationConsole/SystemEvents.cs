...
namespace TestAutomation.Suite
{
   ...
   class SystemEvents :TestBase
    {
        string browserstr = string.Empty;
        public SystemEvents(string browser)
            : base(browser)
        {
            browserstr = browser;
        }
...
Meridian_Common.CurrentTestName = TestContext.CurrentContext.Test.FullName.Remove(0,ix2+1);
         ...
         [Test,Order(1)]
        public void Add_Course_Completion_Code_field_code_to_Classroom_Course_Instructor_scheduled_to_teach_event_email_template()
        {
            #region login
         ...
         [Test, Order(2)]
         public void View_Gamification_Permissions_for_Custom_Roles()
         {
             #region login
             driver.FindElement(By.XPath("//input[@id='MainContent_UC5_btnLogin']")).ClickWithSpace();//logging in
             driver.FindElement(By.XPath("//input[@id='username']")).SendKeysWithSpace("siteadmin");//using regadmin account
