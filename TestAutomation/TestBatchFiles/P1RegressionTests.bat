...
nunit3-console.exe -x86 bin\Debug\TestAutomation.dll --where "cat=chrome" --test=Selenium2.Meridian.Suite.P1RegressionTests
...
powershell.exe -command ". .\SmokeFunctions.ps1; EmailTestGroup6 -envVar_LMSversion '18.2' -envVar_success %DeployToQA% -ReportsDir %FREEDRIVE%\reports"
