...
namespace Selenium2.Meridian
{
    public class Scorm12
    {
      ...
      public void populatesummaryform(IWebDriver iSelenium, string browserstr)
      {
          ...
          try
          {
              driverobj.WaitForElement(By.Id("CNTLCL_TITLE"));
              driverobj.GetElement(By.Id("CNTLCL_TITLE")).Clear();
              driverobj.GetElement(By.Id("CNTLCL_TITLE")).SendKeysWithSpace(ExtractDataExcel.MasterDic_scrom["Title"] + browserstr);
              tocreatescrom = true;
          }
          catch (Exception ex)
          {
        ...
        internal void buttoncreateclick(IWebDriver driver)
        {
            throw new NotImplementedException();
        }

        internal void populatesummaryform(IWebDriver driver)
        {
            throw new NotImplementedException();
        }
        ...
        public bool buttonsaveclick(IWebDriver iSelenium)
      {
        ...
        internal void populatesearchscorm(IWebDriver driver)
        {
            throw new NotImplementedException();
        }
