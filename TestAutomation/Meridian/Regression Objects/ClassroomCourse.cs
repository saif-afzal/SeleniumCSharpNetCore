   ...
   public class ClassroomCourse
    {
        ...
        internal void populateClassroomform(string v1, string v2, int v3)
        {
        ...
        public void buttonsaveframeclick()
        {
            ...
            try
            {
                driverobj.ClickEleJs(By.Id("pnlContent"));
                Thread.Sleep(3000);
                driverobj.WaitForElement(By.Id ("MainContent_UC1_FormView1_CRSSECT_TIME_ZONE_ID"));
                driverobj.ClickEleJs(By.Id("MainContent_UC1_FormView1_CRSSECT_TIME_ZONE_ID"));
                driverobj.WaitForElement(By.Id("MainContent_UC1_Save"));
                driverobj.ClickEleJs(By.Id("MainContent_UC1_Save"));
        ...
        public bool cancelenrollInClassroomCourse()
        {
            ...
            try
            {
                ...
                driverobj.ClickEleJs(By.XPath("//a[contains(.,'Cancel Enrollment')]"));
                Thread.Sleep(4000);
                if (driverobj.existsElement(By.TagName("iframe")))
                {
                    driverobj.waitforframe(By.CssSelector("iframe[class='k-content-frame']"));
                    Thread.Sleep(5000);
        ...
        public string linkmostrecentrequestscontenttitlelinkclick(string v)
        {
            ...
            try
            {
                ...
                result = driverobj.GetElement(By.Id("TabMenu_ML_BASE_TAB_Summary_CRSW_COURSE_TITLE")).Text;
                driverobj.SelectWindowClose2("Edit Approvers/Stages", "Training");
    ...
    public class DisplayFormatCommand
    {
        ...
        {
            Driver.existsElement(By.XPath("//label[@for='display_format']/following::button"));
            return Driver.GetElement(By.XPath("//label[@for='display_format']/following::button")).Text.Contains(v);
        }

        public bool? isDefaultvaluedisplay()
        {
            return Driver.existsElement(By.XPath("//label[@for='display_format']/following::button"));
        }
    }
}
